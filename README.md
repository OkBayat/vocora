...
یک جعبهٔ لایتنر full-stack برای تمرین املای IELTS Listening. رابط کاربری ساده باقی مانده، اما حساب‌ها و تمام وضعیت یادگیری کاربران در MySQL ذخیره می‌شود و با ورود از دستگاه‌های مختلف قابل دسترسی است.
